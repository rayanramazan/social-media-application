...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user.getId().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                    ...
                    String visit_user_id = user.getId();
        ...
        holder.btn_follow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (holder.btn_follow.getText().toString().equals("پەیڕەوى")){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.child(userid).exists()){
                    button.setText("دیفکەفتى");
                    button.setTextColor(0xFF000000);
                    button.setBackgroundColor(0xFFFFFFFF);
                }
                else {
                    button.setText("پەیڕەوى");
                    button.setTextColor(0xFFFFFFFF);
                    button.setBackgroundColor(0xFFFF9063);
                }
            }
